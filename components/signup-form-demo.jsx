    ...
    >
      ...
      <section className="flex flex-col items-center md:w-1/2 text-center space-y-6 md:space-y-8">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://x.com/PatelInData" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        >
          <Link
            href="https://mail.google.com/mail/?view=cm&fs=1&to=pmark2465@gmail.com"
            target="_blank"
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://github.com/patel-mark" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://www.linkedin.com/in/mark-patel-in-data001/" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
