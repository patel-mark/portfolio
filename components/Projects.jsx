...
export default function Projects() {
  ...
  return (
    <section id="projects" className="-mt-8 py-8 pt-0 bg-black text-white w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl text-white lg:text-6xl font-bold inline-block">
        ...
        <div className="flex justify-center rounded-xl mb-10">
          <div className="inline-flex p-1 bg-gray-900/50 rounded-xl">
            {(["landing", "fullstack", "mini"]).map((tab) => (
              <button
                key={tab}
